...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/air_quality_near \
  -H 'Content-Type: application/json' \
  -d '{"latitude":40.785,"longitude":-73.968}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/air_quality_near`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
